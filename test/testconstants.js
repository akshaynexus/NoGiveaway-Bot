...
const NotLibraSpam = ["facebook has released some new info regarding libra"];

const FakeBitmex = ["Bitmex Giveaway", "Bitmex [News]"];
const NotFakeBitmex = ["robin123", "BitMEX Arthur"];
